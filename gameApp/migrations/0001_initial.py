# Generated by Django 5.1.6 on 2025-03-27 00:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, upload_to='static/artifact_icons/')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Game',
            fields=[
                ('user_game', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attack_message', models.CharField(blank=True, max_length=100)),
                ('rarity', models.IntegerField(default=1)),
                ('icon', models.ImageField(blank=True, upload_to='static/weapon_icons/')),
            ],
            options={
                'verbose_name': 'Weapon',
